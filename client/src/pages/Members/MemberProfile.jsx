      ...
      <div className="min-h-screen bg-slate-50 p-4 pb-28 pt-20 sm:p-6 sm:pb-28 sm:pt-20 lg:p-8 lg:pb-28 lg:pt-8">
        <div className="mx-auto max-w-5xl space-y-6">
            ...
            <div className="px-6 pb-6 sm:px-8">
              ...
              <div className="-mt-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="flex min-w-0 items-end gap-3 sm:gap-4">
                  ...
                  <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl border-4 border-white bg-blue-100 text-xl font-bold text-blue-700 shadow-lg sm:h-24 sm:w-24 sm:rounded-3xl sm:text-2xl">
                    {initials}
                  </div>
            ...
            >
              ...
              <div className="flex w-full justify-stretch sm:justify-end">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-400 sm:w-auto"
                >
                  {saving
                    ? "Saving..."
            ...
            >
              ...
              <div className="flex w-full justify-stretch sm:justify-end">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400 sm:w-auto"
                >
                  {changingPassword
                    ? "Changing Password..."
                    : "Change Password"}
         ...
         {/* ==================================================
          ...
          <div className="rounded-2xl border border-red-200 bg-white p-4 shadow-sm sm:rounded-3xl sm:p-8">
