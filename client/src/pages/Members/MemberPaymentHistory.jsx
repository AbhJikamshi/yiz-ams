...
<div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  ...
  <div className="border-b border-slate-200 px-5 py-4 sm:px-6">
    ...
    <p className="mt-1 text-sm text-slate-500">
      Your approved contribution payments are listed below.
    </p>
  </div>
  ...
  {history.payments.length === 0 ? (
    ...
    <div className="flex min-h-[300px] flex-col items-center justify-center px-6 text-center">
      ...
      <p className="mt-1 max-w-md text-sm text-slate-500">
        You do not have any recorded contribution payments yet.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-lg font-bold text-slate-900">
                    {getMonthName(payment.monthNumber)}
                  </p>
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-400"
              >
                {isDownloading
                  ? "Downloading..."
                  : "Download Receipt"}
